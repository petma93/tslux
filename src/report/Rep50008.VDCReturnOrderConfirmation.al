report 50008 "VDC Return Order Confirmation"
{
    DefaultLayout = RDLC;
        ...
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(ShipFromAddrCaption; ShipFromAddrCaptionLbl)
                    {
                    }
                    ...
                    column(TotalVolumeCaption; TotalVolumeCaptionLbl)
                    {
                    }
                    column(TotalVolume; TotalVolumem)
                    {
                    }
    ...
    var
        ...
        BillToAddr: array[4] of Text[100];
        ...
        ShipFromAddrCaptionLbl: Label 'Ship-from Address';
        BillToAddrCaptionLbl: Label 'Bill-to Address';
        TotalVolumeCaptionLbl: Label 'Total packed volume';
    ...
    var
        customReportManagement: Codeunit "Custom Report Management";
    begin
        FormatAddr.GetCompanyAddr(SalesHeader."Responsibility Center", RespCenter, CompanyInfo, CompanyAddr);
        customReportManagement.SalesHeaderShipFrom(CustAddr, SalesHeader);
        ShowShippingAddr := FormatAddr.SalesHeaderShipTo(ShipToAddr, CustAddr, SalesHeader);
        BillToAddr[1] := SalesHeader."Bill-to Name";
        BillToAddr[2] := SalesHeader."Bill-to Address";
        BillToAddr[3] := SalesHeader."Bill-to Post Code" + ' ' + SalesHeader."Bill-to City";
        BillToAddr[4] := SalesHeader."Bill-to Country/Region Code";
    end;
