report 50012 "Registered Pick Shipping Label"
{
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem(Header; "Registered Whse. Activity Hdr.")
        {
            DataItemTableView = SORTING(Type, "No.") WHERE(Type = FILTER(Pick));
            ...
            dataitem(LineFilter; "Registered Whse. Activity Line")
            {
    ...
    var
        ...
        TmpLine: Record "Registered Whse. Activity Line" temporary;
    ...
    procedure FillWhseActLineBuffer(var TmpLineBuffer2: Record "Registered Whse. Activity Line" temporary; Header2: Record "Registered Whse. Activity Hdr.") LinesExist: Boolean
    var
            ...
            if FINDSET() then
                repeat
                    if STDR_ReportSetup."Sum up Lines" then begin
                        TmpLineBuffer2.SETCURRENTKEY("Activity Type", "No.", "Bin Code", "Action Type");
