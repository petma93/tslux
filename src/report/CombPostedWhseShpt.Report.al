    ...
    begin
        if HeaderLoop.Number <= TmpHeaders then
            with Line do begin
                ...
                STDR_ReportManagement.GetLineQtyPriceDisc(Line, LinePrice, LineDisc, Qty, UoMtxt, "Unit Price", "Line Discount %",
            ...
            with Line2 do begin
                ...
                STDR_ReportManagement.GetLineQtyPriceDisc(Line, LinePrice, LineDisc, Qty, UoMtxt, 0, 0, GetQtyPrevTransfer(), Quantity, QuantityPriceUnit, "Unit of Measure", PriceUnitofMeasure);
                STDR_ReportManagement.GetLineQtyPriceDisc(Line, LinePrice, LineDisc, Qty, UoMtxt, 0, 0, 0, Quantity, Quantity, "Unit of Measure", "Unit of Measure");
